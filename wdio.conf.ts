...
import reporter from './TALENTOZ/ROOT/helper/reporter.js';
export const config: Options.Testrunner = {
    ...
    //
    specs: [
        './TALENTOZ/ROOT/POM/features/*/*.feature'
    ],
    // Patterns to exclude.
    exclude: [
    ...
    capabilities: [{
        ...
        timeouts: { implicit: 30000, pageLoad: 50000, script: 20000 },
    ...
    reporters: ['spec',
        ['allure', {
            ...
            reportedEnvironmentVars: {
                ...
                Environment_URL: process.env.WEB_BASE_URL,
                Browser_Name: 'Google Chrome',
                Browser_Version: 'Version 122+',
            },
        }]
    ],
    ...
    cucumberOpts: {
        ...
        require: ['./TALENTOZ/ROOT/POM/features/*/stepDefinition/*.ts'],
    ...
    onPrepare: function (config, capabilities) {
        // Delete the existing allure report folder if it is.
    ...
    beforeScenario: function (world, context) {
        ...
        if (arr.length > 0) this.TESTID = arr[0]
    },
    /**
     *
    ...
    beforeStep: function (step, scenario, context) {
        if (this.TESTID) context.TESTID = this.TESTID    
    },
    /**
     *
